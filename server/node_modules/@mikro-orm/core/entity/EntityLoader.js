...
class EntityLoader {
    ...
    async findChildrenFromPivotTable(filtered, prop, options, orderBy, populate) {
        ...
        /* istanbul ignore next */
        const where = await this.em.applyFilters(prop.type, (_a = options.where[prop.name]) !== null && _a !== void 0 ? _a : {}, (_b = options.filters) !== null && _b !== void 0 ? _b : {}, 'read');
        const fields = this.buildFields(prop, options);
        const options2 = Object.assign({}, options);
        options2.fields = (fields.length > 0 ? fields : undefined);
        /* istanbul ignore next */
        options2.populate = ((_c = populate === null || populate === void 0 ? void 0 : populate.children) !== null && _c !== void 0 ? _c : []);
        if (prop.customType) {
